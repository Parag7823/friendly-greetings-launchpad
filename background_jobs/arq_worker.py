...
# REPLACED: Removed imports of NangoClient and sync functions (now handled by Airbyte)
...
# ============================================================================
# SYNC TASKS REMOVED - All replaced by Airbyte connectors
# ============================================================================
# Removed tasks:
...
# - zoho_mail_sync()
#
# Airbyte now handles all sync orchestration, rate limiting, and locking.
# ============================================================================
