...
class AidentMemoryManager:
    ...
    async def add_message(self, user_message: str, assistant_response: str) -> bool:
        ...
        """
        try:
            # FIX #18: Detect frustration in user message
            self.detect_frustration(user_message)
            ...
            # FIX #18: Update conversation state for repetition detection
            self.update_conversation_state(user_message, assistant_response)
