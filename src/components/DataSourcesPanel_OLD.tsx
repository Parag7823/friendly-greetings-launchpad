...
const AVAILABLE_INTEGRATIONS = {
  accounting: [
    { id: 'quickbooks', name: 'QuickBooks Online', icon: '📊', provider: 'quickbooks' },
    { id: 'xero', name: 'Xero', icon: '💼', provider: 'xero' },
  ],
  cloud_storage: [
    { id: 'google_drive', name: 'Google Drive', icon: '📁', provider: 'google_drive' },
    { id: 'dropbox', name: 'Dropbox', icon: '📦', provider: 'dropbox' },
  ],
  email: [
    { id: 'gmail', name: 'Gmail', icon: '📧', provider: 'gmail' },
    { id: 'zoho_mail', name: 'Zoho Mail', icon: '✉️', provider: 'zoho_mail' },
  ],
  banking: [
    { id: 'plaid', name: 'Bank Accounts (Plaid)', icon: '🏦', comingSoon: true },
  ],
};
...
export const DataSourcesPanel = ({ isOpen, onClose }: DataSourcesPanelProps) => {
  ...
  const [expandedCategories, setExpandedCategories] = useState<Set<string>>(new Set(['accounting']));
